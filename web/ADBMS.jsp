...
<%
    ...
    try {
        ...
        String subjectQuery = "SELECT subject_id FROM subjects WHERE subject_name = 'Advanced DBMS'";
...
<head>
    ...
    <title>Advanced DBMS Notes</title>
...
<body>
    ...
    <div class="container">
        <h2 class="header">&#x1F4D8; Advanced DBMS Notes</h2>
