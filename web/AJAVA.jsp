...
<%
    ...
    try {
        ...
        String subjectQuery = "SELECT subject_id FROM subjects WHERE subject_name = 'Advanced Java'";
...
<head>
    ...
    <title>Advanced Java Notes</title>
...
<body>
    ...
    <div class="container">
        <h2 class="header">&#x1F4D8; Advanced Java Notes</h2>
